    ...
    internal class CustomCombobox : UserControl
    {
        ...
        public bool IsReadOnly
        {
            ...
            set
            {
                ...
                // Nếu bật WhiteMode thì mới hiện trắng, còn lại hiện xám chuẩn
                if (value) lblText.ForeColor = readOnlyWhiteMode ? Color.White : Color.Gray;
                else lblText.ForeColor = this.ForeColor;
            }
        }
