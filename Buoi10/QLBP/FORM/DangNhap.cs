        ...
        private void btnDangNhap_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                using (var context = new QLBPDbContext())
                {
                    ...
                    if (nv == null)
                    {
                        QLBP.SERVICES.LogService.LogWarning(tenDN, "Đăng nhập thất bại", "Tên đăng nhập không tồn tại.");
                    ...
                    {
                        QLBP.SERVICES.LogService.LogWarning(nv.HoVaTen, "Đăng nhập thất bại", "Mật khẩu không đúng.");
                    ...
                    NhanVienDangNhap = nv;
                    QLBP.SERVICES.LogService.LogInfo(nv.HoVaTen, "Đăng nhập", "Đăng nhập vào hệ thống thành công.");
