    ...
    public partial class frmNhanVien : Form
    {
        ...
        private void btnXoa_Click(object sender, EventArgs e)
        {
            ...
            if (MessageBox.Show("Xác nhận xoá người này?", "Xoá", MessageBoxButtons.YesNo, MessageBoxIcon.Question) == DialogResult.Yes)
            {
                ...
                if (nv != null)
                {
                    string tenNV = nv.HoVaTen;
                    context.NhanVien.Remove(nv);
                    context.SaveChanges();
                    QLBP.SERVICES.LogService.LogInfo("Quản lý", "Xoá nhân viên", $"Đã xoá nhân viên: {tenNV}");
                }
            ...
            else
            {
                if (xuLyThem)
                {
                    ...
                    else
                    {
                        ...
                        context.SaveChanges();
                        QLBP.SERVICES.LogService.LogInfo("Quản lý", "Thêm nhân viên", $"Đã thêm nhân viên mới: {nv.HoVaTen}");
                    }
                }
                else if (xuLySua)
                {
                    ...
                    if (nv != null)
                    {
                        ...
                        if (string.IsNullOrEmpty(txtMatKhau.Text))
                            ...
                            nv.MatKhau = BC.HashPassword(txtMatKhau.Text);
                        context.SaveChanges();
                        QLBP.SERVICES.LogService.LogInfo("Quản lý", "Cập nhật nhân viên", $"Đã cập nhật thông tin nhân viên: {nv.HoVaTen}");
                    }
                }
                else
                {
