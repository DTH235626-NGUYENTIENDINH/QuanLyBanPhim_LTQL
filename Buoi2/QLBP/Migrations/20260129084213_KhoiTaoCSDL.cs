    ...
    public partial class KhoiTaoCSDL : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_LoaiBanPhims", x => x.ID);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    HangSanXuatID = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    LoaiBanPhimID = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    LoaiSwitch = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    GiaBan = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
                    SoLuong = table.Column<int>(type: "int", nullable: false),
                    HinhAnh = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    MoTa = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    LoaiBanPhimID1 = table.Column<int>(type: "int", nullable: false),
                    HangSanXuatID1 = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_banPhim", x => x.ID);
                    table.ForeignKey(
                        name: "FK_banPhim_HangSanXuat_HangSanXuatID1",
                        column: x => x.HangSanXuatID1,
                        principalTable: "HangSanXuat",
                        principalColumn: "ID",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_banPhim_LoaiBanPhims_LoaiBanPhimID1",
                        column: x => x.LoaiBanPhimID1,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_banPhim_HangSanXuatID1",
                table: "banPhim",
                column: "HangSanXuatID1");

            migrationBuilder.CreateIndex(
                name: "IX_banPhim_LoaiBanPhimID1",
                table: "banPhim",
                column: "LoaiBanPhimID1");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_HoaDonChiTiet_BanPhimID",
                table: "HoaDonChiTiet",
                column: "BanPhimID");
