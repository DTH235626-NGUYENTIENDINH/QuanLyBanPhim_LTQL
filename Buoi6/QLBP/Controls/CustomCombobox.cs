...
namespace QLBP.Controls
{
    ...
    internal class CustomCombobox : UserControl
    {
        ...
        [Category("Custom ComboBox")]
        [Browsable(false)] // Ẩn khỏi bảng Properties vì thường dùng trong code
        ...
        public bool IsReadOnly
        {
            ...
            set
            {
                ...
                // Label vẫn Enabled = true nên nó KHÔNG bị đổi màu hệ thống
                // Nhưng mình chủ động đổi màu xám để người dùng biết là bị khóa
                lblText.ForeColor = value ? Color.Gray : this.ForeColor;
            }
        }
        ...
        public CustomCombobox()
        {
            ...
            cmbList.SelectedIndexChanged += new EventHandler(cmbList_SelectedIndexChanged); //Default event
            cmbList.TextChanged += new EventHandler(cmbList_TextChanged); //Reset text
            ...
            btnIcon.Click += new EventHandler(btnIcon_Click); //open dropdown list
            btnIcon.Paint += new PaintEventHandler(btnIcon_Paint); //Draw icon
            ...
            //--> Attach click event to label and user control to open dropdown list
            lblText.Click += new EventHandler(Surface_Click); //select item cbo
            lblText.MouseEnter += new EventHandler(Surface_MouseEnter); //select item cbo
            lblText.MouseLeave += new EventHandler(Surface_MouseLeave); //select item cbo
        ...
        private void Surface_Click(object? sender, EventArgs e)
        {
            ...
            // Prevent dropdown if disabled or read-only
            if (this.IsReadOnly || !this.Enabled) return;

            //select item
            cmbList.Select();
            if (cmbList.DroppedDown == false)
            {
        ...
        protected override void OnEnabledChanged(EventArgs e)
        {
            ...
            {
                lblText.ForeColor = Color.Gainsboro;
            }
        }
    } 
}
